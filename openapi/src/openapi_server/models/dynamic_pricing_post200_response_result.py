...
class DynamicPricingPost200ResponseResult(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of DynamicPricingPost200ResponseResult from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of DynamicPricingPost200ResponseResult from a dict"""
        if obj is None:
            return None
